<template>
  <div class="bg-slate-800/50 border border-slate-700 rounded-xl flex flex-col">
    <!-- Header -->
    <div
        class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 px-4 sm:px-5 py-3 sm:py-4 border-b border-slate-700">
    ...
    <div class="flex-1 overflow-y-auto max-h-[400px] sm:max-h-[520px] p-3 space-y-2">
          ...
          <div class="flex-1 px-3 sm:px-4 py-3 min-w-0">
            ...
            <div class="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-0.5 sm:gap-2 mb-1">
              <p class="text-sm font-semibold text-white leading-snug min-w-0">
                <span class="text-xs font-bold uppercase tracking-wide mr-1.5"
                      :class="severityTextColor[alert.severity]">{{
      ...
      <div v-if="filteredAlerts.length === 0"
           class="flex flex-col items-center justify-center py-12 text-slate-500 text-center px-4">
        ...
        <div
          ...
          <div
            ...
            <button @click="selected = null"
                    class="text-slate-400 hover:text-white transition-colors flex-shrink-0 p-1">
              <X class="w-5 h-5"/>
            </button>
          </div>
          ...
          <div class="flex-1 overflow-y-auto px-4 sm:px-6 py-4 space-y-3">
            ...
            <div class="grid grid-cols-2 gap-2 sm:gap-3">
              ...
              <div v-if="selected.count" class="field-box">
                <p class="text-xs text-slate-500 mb-1 flex items-center gap-1.5">
                  <Hash class="w-3 h-3"/>
                  Eventos
                </p>
