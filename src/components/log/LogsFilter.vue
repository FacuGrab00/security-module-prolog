<template>
  <div class="bg-slate-800/50 border border-slate-700 rounded-xl px-4 py-3 flex flex-col gap-3">
    ...
    <div class="flex items-center gap-2 flex-wrap">
      <AppSelect :model-value="resultFilter" @update:model-value="emit('update:resultFilter', $event)"
                 :options="resultOptions"/>
      <AppSelect :model-value="roleFilter" @update:model-value="emit('update:roleFilter', $event)"
                 :options="roleOptions"/>
